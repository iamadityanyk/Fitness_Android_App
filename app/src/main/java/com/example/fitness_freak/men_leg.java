...
public class men_leg extends AppCompatActivity {
    ...
    private int [] images={R.drawable.men_sidehop,R.drawable.men_squats,R.drawable.men_sidelying_left
            ,R.drawable.men_sidelyingleg_right,
            R.drawable.men_backward_lunge,R.drawable.men_sumosquat,R.drawable.men_knee_chest_stretch};
    private String [] times={"45 Sec","X15","X15","X15","X30","X15","45 Sec"};
    @Override
